...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            evaluator.addFunction(new AddFunction());
            evaluator.addFunction(new IfelseFunction());
            evaluator.addFunction(new QuotFunction());
            evaluator.addFunction(new EqualFunction());
            evaluator.addFunction(new SquaredFunction());
            evaluator.addFunction(new ModuloFunction());
            evaluator.addFunction(new MultFunction());
            evaluator.addFunction(new FactorialFunction());
            evaluator.addFunction(new TriFunction());
